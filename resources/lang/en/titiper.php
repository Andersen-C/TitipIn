...
return [
    ...
    'latestOrd' => 'Latest Order',
    'latestOrdSub' => 'Your Latest Order Summary',
    ...
    'PaymentSummaryPage' => [
        ...
        'floor' => 'Floor',
        'DeliveryNote' => 'Make sure you are at this location when the order arrives.',
        'PaymentMethod' => 'Payment Method',
        'CashOnDelivery' => 'Cash On Delivery',
        'CashOnDeliverySub' => 'Pay in cash to the runner upon delivery.',
        'BankTransfer' => 'Bank Transfer',
        'PaymentNotes' => 'The payment method can be changed until you confirm the order.',
        'Subtotal' => 'Subtotal',
        'Service' => 'Service Fee',
        'Total' => 'Total',
        'TitipNow' => 'Titip Now',
    ...
    'OrdersListPage' => [
        ...
        'CancelOption' => [
            ...
            'option2' => 'Want to change the address',
            'option3' => 'Want to change the address',
            'option4' => 'Others'
        ],
        'Cancel' => 'Cancel',
