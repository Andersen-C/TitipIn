    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div class='space-y-6'>
            <h1 class="text-4xl md:text-5xl font-extrabold leading-tight">
                <span class="text-blue-700">{{__('beforeLogin.Title1')}}</span>
                <br>
                <span class="text-amber-500">{{__('beforeLogin.Title2')}}</span>
            </h1>
