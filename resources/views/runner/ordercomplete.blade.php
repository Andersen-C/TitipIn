    ...
    <div class="sm:hidden  bg-white rounded-2xl shadow-sm border border-slate-100 p-8 mb-3 overflow-x-auto ">
        <div class="flex items-center justify-between">
            ...
            <div class="flex  items-center justify-center gap-3">
                ...
                <div class="text-blue-700 font-semibold hover:bg-blue-950">
                    Tiba di Kantin
                </div>
            </div>
    ...
    <div class="flex flex-col  lg:flex-row gap-6  items-start">
        ...
        <div class="w-full lg:flex-1 bg-white   rounded-2xl shadow-sm border border-slate-100 p-2 sm:p-6 md:p-8">
            ...
            <div class="mb-8">
                ...
                <a href="#" class="w-full bg-blue-700  hover:bg-blue-800 text-white font-semibold py-4 px-6 rounded-lg transition duration-200 ">
        ...
        <div class="w-full lg:w-[400px] flex flex-col gap-6">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
                ...
                <p class="opacity-80  mb-4">1x • Rp 25.000</p>
